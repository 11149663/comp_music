...
Runescape were still a thing. 

In general, the website offers a plugin for you to install on your PC and phone, 
which can track your listening behaviour. The data is then transferred ("scrobbled")
to the database and displayed on your personal profile. With the accumulated data, 
they could also recommend you new/similar music to discover or connect you to people 
with similar music taste.

Although the social aspects have been watered down, I've still been using their 
service ever since June 2011 (1). With the *vast* amount of data up for grabs, it 
...
**What do you expect to be different among these groups, what do you expect to be the same, and what are you unsure about?**
