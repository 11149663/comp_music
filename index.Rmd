...
One listen, a **scrobble**, is then transferred ("scrobbled") to the database and displayed on your 
...
*some consistencies to be expected (post-punk) ... new music styles introduced*
*between 2015-2017 ... more East Asian music present starting from late 2018]*
...
or interludes. *[note to self: add hyperlink for examples]*
...
- Some underrepresentation of certain music styles in the top 100. 
Song 1 of style A has 100 scrobbles, song 2 and 3 of style B have 60 each.
Style A has 100 scrobbles, and style B has 120. *[need to explain this better...]*
